...
%ADD MOTIVATION
This motivates to investigate the possibilities and limitations of a rarely used nonlinear Geometric Control approach, and to investigate the performance of a load transportation maneuver, when compared to a commonly used linear control strategy.
