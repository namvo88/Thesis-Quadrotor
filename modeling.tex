...
Section \ref{sec:mod.QRmod} starts by discussing assumptions that are applied to simplify the model. Next, a dynamical model of the \a{qr} is presented. 
In Section \ref{sec:mod.QRLmod}, the same is done to obtain a dynamical model of the \a{qr}-load system with geometric mechanics, resulting in a compact, coordinate-free, unambiguous representation of the dynamics, described on nonlinear manifolds.
...
\begin{figure}[h!]
	\centering
	\makebox[.69\textwidth][c]{\subfloat[][QR model with forces and moments \label{fig:}]{\includegraphics[trim={0 0 0 1cm},clip,width=.65\textwidth]{./StyleStuff/qrmodel2.png}}}
	\makebox[.3\textwidth][c]{\subfloat[][Angle representation \label{fig:mod.angQR}]{\includegraphics[trim={5cm -5cm 5cm 3cm},clip,width=.29\textwidth]{./StyleStuff/anglesQR.png}}}
...
\begin{figure}[h!]
	\centering
	\makebox[.65\textwidth][c]{\subfloat[][QR model with load \label{fig:}]{\includegraphics[trim={0 0 0 1cm},clip,width=.65\textwidth]{./StyleStuff/qrlmodel.png}}}
	\makebox[.3\textwidth][c]{\subfloat[][Angle representation \label{fig:mod.angL}]{\includegraphics[trim={5cm -3cm 5cm 1cm},clip,width=.3\textwidth]{./StyleStuff/angles.png}}}
	\caption{quadrotor with load model representation\label{fig:mod.modelQRL}}
\end{figure}		
