...
\end{aligned}
\end{equation}
After rearranging and setting each variation to 0, the following equations of motion for the \a{qr}-Load system are found. Where, Equations \ref{eq:mod.attitude} and \ref{eq:mod.R} 
